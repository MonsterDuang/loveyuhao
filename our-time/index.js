$(() => {
  ...
  const birthstr = curMonth == 9 && curDay == 27 ? `- 今天是我们朗朗<b>${toChinesNum(curYear - 2022)}周岁</b>生日!!!` : curMonth == 2 && curDay == 13 ? `- 今天是亲爱的老婆<b>${toChinesNum(curYear - 1998)}周岁</b>生日!!!` : curMonth == 11 && curDay == 19 ? `- 今天是Monster<b>${toChinesNum(curYear - 1996)}周岁</b>生日!!!` : '';
